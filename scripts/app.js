...
React.render(React.createElement("div", null,
                ...
                React.createElement(PerformanceAlert, null),
...
},{"./components/application":162,"./components/article":163,"./components/performanceAlert":166,"./components/social":168,"./core/dispatcher":171,"./core/performance":172,"react":161}],2:[function(require,module,exports){
...
var Application = React.createClass({displayName: "Application",
    ...
    render: function(){
        ...
        return (React.createElement("div", {className: "viewspace", style: style},
                    React.createElement(Stars, null),
                    React.createElement(Planet, {name: "mercury", boxHeight: height, left: "50"}),
                    React.createElement(Planet, {name: "venus", boxHeight: height, left: "150"}),
                    React.createElement(Planet, {name: "earth", boxHeight: height, left: "320"}),
                    React.createElement(Planet, {name: "mars", boxHeight: height, left: "495"}),
                    React.createElement(Planet, {name: "jupiter", boxHeight: height, left: "600"}),
                    React.createElement(Planet, {name: "saturn", boxHeight: height, left: "1000"}),
                    React.createElement("div", {className: "saturn__outer-ring"}),
                    React.createElement("div", {className: "saturn__inner-ring"}),
                    React.createElement(Planet, {name: "uranus", boxHeight: height, left: "1350"})
                ));
    }
});
...
},{"../core/dispatcher":171,"./planet":167,"./stars":170,"react":161}],163:[function(require,module,exports){
var React = require('react'),
    ...
    render: function(){
        var selectedArticle = this.state.selectedPlanet || 'solar',
            articleText = (articlesData[selectedArticle] || []).map(function(node){
                ...
                return (React.createElement("div", {className: nodeClass}, node.text));
            });

        return (React.createElement("div", {className: "article"}, articleText));
    }
});
...
},{"../core/dispatcher":171,"../data/articles":173,"react":161}],164:[function(require,module,exports){
var React = require('react');
...
var Line = React.createClass({displayName: "Line",
    render: function(){
        ...
        return (React.createElement("div", {className: "line", style: style}));
    }
});
...
var Particle = React.createClass({displayName: "Particle",
    getInitialState: function(){
        return {
    ...
    render: function (){
        ...
        return (React.createElement("div", {className: "particle", style: style}));
    }
});
...
},{"../core/dispatcher":171,"react":161}],166:[function(require,module,exports){
var React = require('react'),
    dispatcher = require('../core/dispatcher');

var PerformanceAlert = React.createClass({displayName: "PerformanceAlert",
    getInitialState: function(){
    ...
    render: function(){
        ...
        return (React.createElement("div", {style: style, className: "performance__alert"}, "Your browser are rendering scene too slow. Try to use Chrome for better performance!"));
    }
});
...
},{"../core/dispatcher":171,"react":161}],167:[function(require,module,exports){
var React = require('react'),
...
var Planet = React.createClass({displayName: "Planet",
    getInitialState: function(){
        var particles = [],
            lines = [],
        ...
        for(var i = 0; i < (data.lines || []).length; i ++){
            line = data.lines[i];
            lines.push(React.createElement(Line, {key: 'line:' + i, top: line.top, height: line.height, color: line.color}));
        }

        for(var i = 0; i < (data.particles || []).length; i ++){
            particle = data.particles[i];
            for(var j = 0; j < data.particles[i].count; j ++){
                particles.push(React.createElement(Particle, {key: 'particle:' + i + ',' + j, length: data.size, size: data.size * particle.size,
    ...
    render: function(){
        ...
        return (React.createElement("div", {className: "planet", onClick: this.onPlanetClick, style: style},
                    React.createElement("div", {className: "shadow", style: shadowStyle}),
...
},{"../core/dispatcher":171,"../data/planets":174,"./line":164,"./particle":165,"node-uuid":6,"react":161}],168:[function(require,module,exports){
var React = require('react');
...
var Social = React.createClass({displayName: "Social",
    ...
    render: function(){
        return (React.createElement("div", {className: "social"},
                    ...
                    React.createElement("div", {className: "icon-info", onClick: this.onInfoClick})
                ));
    }
});
...
var Stars = React.createClass({displayName: "Stars",
    componentDidMount : function(){
        dispatcher.register(function(payload){
            ...
            for(var i = 0; i < 750; i ++){
                stars.push(React.createElement(Star, {boxWidth: width, boxHeight: height, key: i}));
            }
    ...
    render: function(){
        return (React.createElement("div", {className: "stars"}, this.state.stars));
    }
});
...
},{"../core/dispatcher":171,"./star":169,"react":161}],171:[function(require,module,exports){
...
},{"./dispatcher":171}],173:[function(require,module,exports){
module.exports = {
    uranus:[{
        text: 'Uranus',
    ...
    solar: [{
        ...
        text: 'The Solar System was formed approximately 4.6 billion years ago and consists of the Sun, planets, dwarf planets and other astronomical objects bound in its orbit. The formation was cause by the collapse of a giant molecular cloud, the mass at the centre collecting to form the Sun and a flat disk of dust around it which the planets and other bodies would eventually be formed from.'
    },{
        text: '99.86% of the system’s mass is found in the Sun and the majority of the remaining 0.14% is contained within the solar system’s eight planets.'
    },{
        text: 'The four smaller inner planets, also known as the “terrestrial planets” (Mercury, Venus, Earth and Mars), are primarily composed of rock and metal. The four outer planets, also known as the “gas giants” (Jupiter, Saturn, Uranus and Neptune), are substantially larger and more massive than the inner planets.'
    },{
        text: 'The two innermost gas giants, Jupiter and Saturn, are the larger of the four and are composed mainly of hydrogen and helium. The two outermost gas giants, Uranus and Neptune, are composed largely of ices, (water, ammonia and methane) and are sometimes also referred to as the “ice giants“.'
    },{
        text: 'Other objects of note in the Solar System are the dwarf planets (Ceres, Pluto, Haumea, Makemake & Eris), moons, asteroids, the asteroid belt, comets and the Kuiper belt.'
    }],
    earth: [{
        text: 'Earth',
        class: 'article-node__highlight'

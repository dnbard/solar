...
React.render(React.createElement('div', null, React.createElement(Application, { id: 'aappy' }), React.createElement(PerformanceAlert, null), React.createElement(Article, null), React.createElement(Social, null)), applicationNode);
...
var Article = React.createClass({ displayName: 'Article',
    ...
    render: function render() {
        var selectedArticle = this.state.selectedPlanet || 'solar',
            ...
            return React.createElement('div', { key: index, className: nodeClass }, node.text);
        });
...
var Planet = React.createClass({ displayName: 'Planet',
    ...
    onPlanetClick: function onPlanetClick() {
        dispatcher.dispatch({
    ...
    render: function render() {
        ...
        return React.createElement('div', { className: 'planet', onClick: this.onPlanetClick, style: style }, React.createElement('div', { className: 'shadow', style: shadowStyle }), this.state.particles, this.state.lines);
    }
});
...
var Stars = React.createClass({ displayName: 'Stars',
    componentDidMount: function componentDidMount() {
        dispatcher.register((function (payload) {
            ...
            if (payload.action !== 'viewspace-mounted') {
                return;
            }
